...
CAMERA = 'camera=x ! qtivtransform ! video/x-raw(memory:GBM),format=NV12,width=640,height=480,framerate=30/1,compression=ubwc ! waylandsink x=10 y=50 width=640 height=480 async=true sync=false'

POSE_DETECTION = 'camera=x ! qtivtransform ! video/x-raw(memory:GBM),format=NV12,width=640,height=480,framerate=30/1,compression=ubwc ! tee name=split \
split. ! queue ! qtivcomposer name=mixer ! waylandsink x=10 y=50 width=640 height=480 async=true sync=false \
...
SEGMENTATION = 'camera=x ! qtivtransform ! video/x-raw(memory:GBM),format=NV12,width=640,height=480,framerate=30/1,compression=ubwc ! tee name=split \
split. ! queue ! qtivcomposer name=mixer sink_1::alpha=0.5 ! queue ! waylandsink x=10 y=50 width=640 height=480 async=true sync=false \
...
CLASSIFICATION = 'camera=x ! qtivtransform ! video/x-raw(memory:GBM),format=NV12,width=640,height=480,framerate=30/1,compression=ubwc !queue ! tee name=split \
split. ! queue ! qtivcomposer name=mixer sink_1::position="<30,30>" sink_1::dimensions="<320, 180>" ! queue ! waylandsink x=10 y=50 width=640 height=480 async=true sync=false \
...
OBJECT_DETECTION = 'camera=x ! qtivtransform ! video/x-raw(memory:GBM),format=NV12,width=640,height=480,framerate=30/1,compression=ubwc !queue ! tee name=split \
split. ! queue ! qtivcomposer name=mixer1 ! queue ! waylandsink x=10 y=50 width=640 height=480 async=true sync=false \
